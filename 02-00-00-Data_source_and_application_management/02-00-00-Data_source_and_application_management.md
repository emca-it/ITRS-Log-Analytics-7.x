...
#### Interactive installation using "install.sh"
  ...
  - unpack the archive containing the installer
    `tar xjf itrs-loganalytics-${product-version}.x.x86_64.tar.bz2`
...
Configuration steps
1. Create a new alert rule or edit an existing one according to the instruction: [Creating Alerts](https://itrs-log-analytics-7x.readthedocs.io/en/latest/08-00-00-Alert_module/08-00-00-Alert_module.html#creating-alerts),
